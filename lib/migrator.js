...
var Migrator = function(migrations, curVersion) {
  this.migrations = migrations;
  this.currentVersion = (typeof curVersion == 'undefined') ? 0 : curVersion;
};

Migrator.prototype.migrate = function() {
  var curVersion = this.currentVersion;

  var migrations = this.migrations.filter(function(migration) {
    return migration.version > curVersion;
  });
